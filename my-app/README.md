...
For OHLC chart i used third party JavaScript (HTML5) tool "fusioncharts.com".
I used redux (Redux Thunk middleware) for fatching api's data and store thode data in redux-store.
